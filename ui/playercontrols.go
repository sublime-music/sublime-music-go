...
func CreatePlayerControls() *PlayerControls {
	...
	builderSmallest := gtk.NewBuilderFromResource("/app/sublimemusic/SublimeMusicNext/ui/playercontrolssmallest.ui")
	...
	squeezer.Add(builderSmallest.GetObject("root").Cast().(*gtk.Box))
